...
from .models import DrugInteraction, MedicationInteractionKnowledge, MedicationReference, MedicationSideEffect
...
@receiver([post_save, post_delete], sender=DrugInteraction)
