...
export function WidgetCard({
    ...
    return (
        <Card 
            className={cn("overflow-hidden", onClick && "cursor-pointer hover:border-primary/50 transition-colors", className)} 
            onClick={onClick}
        >
...
export function MetricCard({
    ...
    return (
        <WidgetCard title={title} icon={icon} className={className} onClick={onClick}>
            {loading ? (
