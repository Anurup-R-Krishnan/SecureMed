...
const MOCK_NOTES: HuddleNote[] = [
    { id: '1', author: 'Dr. Smith', role: 'MD', content: 'Hold discharge until Cardio consult complete.', type: 'medical', isResolved: false },
    { id: '2', author: 'Sarah J.', role: 'RN', content: 'IV access difficult. Needs PICC line?', type: 'medical', isResolved: false },
    { id: '3', author: 'Mike T.', role: 'SW', content: 'Family meeting scheduled for 2pm today.', type: 'social', isResolved: false },
    { id: '4', author: 'Lisa R.', role: 'PT', content: 'Cleared for stairs. Needs walker ordered.', type: 'logistics', isResolved: true },
];
...
export function HuddleBoard() {
    return (
        <div className="bg-repeat space-y-6" style={{ backgroundImage: 'radial-gradient(#e5e7eb 1px, transparent 1px)', backgroundSize: '20px 20px' }}>
            ...
            <div className="flex justify-between items-center bg-card/80 backdrop-blur p-4 rounded-xl border shadow-sm sticky top-20 z-10">
                <div>
                    <h3 className="font-black text-xl tracking-tight">Morning Huddle Board</h3>
                    <p className="text-sm text-muted-foreground">Team collaboration & Discharge Blockers</p>
                </div>
