...
import { AlertTriangle, Clock, XOctagon, Droplets, Activity, Ban } from 'lucide-react';
                ...
                >
                    ...
                    <div className="bg-red-600 text-white p-6 flex justify-between items-center shadow-2xl">
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                <h1 className="text-4xl font-black tracking-tighter uppercase">Trauma / Code Blue</h1>
                                <p className="text-red-100 font-mono text-lg tracking-widest">PROTOCOL ACTIVE</p>
                            </div>
                        </div>

                        <div className="flex items-center gap-8">
                            <div className="text-right">
                                <div className="text-sm font-bold opacity-80 uppercase">Event Timer</div>
                                <div className="text-5xl font-mono font-black tabular-nums">{formatTime(elapsedTime)}</div>
                            </div>
                            <Button
                    ...
                    <div className="flex-1 p-8 grid grid-cols-12 gap-8 bg-zinc-950 text-white">
                        ...
                        <div className="col-span-12 md:col-span-4 bg-zinc-900 border-l-8 border-blue-500 p-8 rounded-r-xl">
                            <div className="text-zinc-400 text-xl font-bold uppercase mb-2">Patient</div>
                            <div className="text-5xl font-black">Jane Doe</div>
                            <div className="text-3xl font-mono text-zinc-400 mt-2">#992-831-22</div>
                            <div className="mt-8 text-2xl font-bold text-blue-400">DOB: 12/05/1980 (45y)</div>
                        </div>
                        ...
                        <div className="col-span-6 md:col-span-2 bg-zinc-900 border-l-8 border-red-500 p-8 rounded-r-xl flex flex-col justify-center items-center">
                            ...
                            <div className="text-zinc-400 font-bold uppercase">Blood Type</div>
                        ...
                        <div className="col-span-6 md:col-span-2 bg-zinc-900 border-l-8 border-amber-500 p-8 rounded-r-xl flex flex-col justify-center items-center">
                            ...
                            <div className="text-4xl font-black text-amber-500 text-center leading-tight">PENICILLIN<br />LATEX</div>
                        </div>
                        ...
                        <div className="col-span-12 md:col-span-4 bg-zinc-900 border-l-8 border-green-500 p-8 rounded-r-xl grid grid-rows-3 gap-6">
                            <div className="flex justify-between items-center border-b border-zinc-800 pb-4">
                                ...
                                <div className="text-6xl font-mono font-black text-green-500">0 <span className="text-xl text-zinc-500">bpm</span></div>
                            </div>
                            <div className="flex justify-between items-center border-b border-zinc-800 pb-4">
                                <div className="text-2xl font-bold text-zinc-400">BP</div>
                                <div className="text-6xl font-mono font-black text-red-500">--/--</div>
                            </div>
                            <div className="flex justify-between items-center">
                                <div className="text-2xl font-bold text-zinc-400">SpO2</div>
                                <div className="text-6xl font-mono font-black text-blue-500">--%</div>
                            </div>
                        </div>

                        {/* Action Log Placeholder */}
                        <div className="col-span-12 bg-zinc-900/50 border border-zinc-800 p-6 rounded-xl overflow-hidden">
                            <div className="text-zinc-500 font-bold uppercase tracking-widest mb-4">Code Log</div>
