    ...
    return (
        <AlertDialog>
            ...
            <AlertDialogContent className="bg-background/80 backdrop-blur-2xl border-border/50 rounded-[32px] shadow-2xl">
                <AlertDialogHeader>
                    <AlertDialogTitle className="text-2xl font-black tracking-tight">End Session?</AlertDialogTitle>
                    <AlertDialogDescription className="text-base text-muted-foreground">
                        You are about to securely sign out of SecureMed. All unsaved changes will be lost.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter className="gap-2">
                    <AlertDialogCancel className="rounded-xl border-border/50 bg-muted/20 hover:bg-muted/40 h-10 mt-0">Cancel</AlertDialogCancel>
                    <AlertDialogAction
