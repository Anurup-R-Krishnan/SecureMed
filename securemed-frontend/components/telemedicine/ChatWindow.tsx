    ...
    <div className="flex flex-col h-full bg-background relative">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold">
            {(
              ...
              activeOtherParticipant?.username?.[0] ||
              "U"
            ).toUpperCase()}
          </div>
          <div>
      ...
      <div className="p-4 sm:p-6 bg-background border-t border-border/40">
        <form
          ...
          className="flex gap-3 items-center bg-muted/30 p-1.5 pr-2 rounded-full border border-border/60 hover:border-primary/30 transition-colors focus-within:border-primary/50 focus-within:ring-4 focus-within:ring-primary/5"
        >
          <input
            ref={fileInputRef}
            type="file"
          ...
          >
            <Send
              size={18}
              className={isLoading ? "animate-pulse" : "ml-0.5"}
            />
          </Button>
        </form>
      </div>
