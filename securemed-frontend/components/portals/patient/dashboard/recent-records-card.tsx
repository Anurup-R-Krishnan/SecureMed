          ...
          {records.map((record, index) => {
            ...
            return (
              <div key={record.id} className="relative pl-12">
                {/* Timeline node */}
                <div
                  className={`absolute left-[18px] top-3 h-3 w-3 rounded-full border-2 border-background ${colorClass.split(" ")[1]} z-10`}
                />
                ...
                >
                  <div className="flex items-start gap-3">
                    <div
                      className={`h-10 w-10 shrink-0 rounded-lg ${colorClass} flex items-center justify-center`}
                    >
