...
export default function PharmacyInventory() {
  ...
  const drugColumns: Column<Drug>[] = [
    ...
    },
    {
      header: "Price",
      cell: (drug) => (
        <span className="font-mono text-right w-full block">
          ₹{drug.unit_price}
        </span>
      ),
    ...
    },
    {
      ...
      cell: (batch) =>
        batch.is_expired ? (
          ...
          <Badge
            variant="secondary"
            className="bg-yellow-100 text-yellow-700 hover:bg-yellow-100 rounded-full"
          >
            Expiring Soon
          </Badge>
        ) : (
  ...
  const expiringBatches = batches.filter(
    (b) => !b.is_expired && b.days_to_expiry <= 90,
  );
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 space-y-2">
        {lowStockDrugs.length > 0 && (
          <Alert>
            ...
            <AlertDescription>
              {lowStockDrugs.length} drug(s) need reordering
            </AlertDescription>
          </Alert>
        )}
                ...
                {lowStockDrugs.map((drug) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{drug.drug_code}</p>
                    </div>
                    <div className="text-right">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setDrugForm({ ...drugForm, drug_code: e.target.value })
                }
              />
            </div>
            <div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setDrugForm({ ...drugForm, generic_name: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setDrugForm({ ...drugForm, manufacturer: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setDrugForm({ ...drugForm, dosage_form: e.target.value })
                }
              >
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setDrugForm({ ...drugForm, unit_price: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setDrugForm({ ...drugForm, reorder_level: e.target.value })
                }
              />
            </div>
          </div>
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                className="w-full border rounded p-2"
                value={batchForm.drug}
                onChange={(e) =>
                  setBatchForm({ ...batchForm, drug: e.target.value })
                }
              >
