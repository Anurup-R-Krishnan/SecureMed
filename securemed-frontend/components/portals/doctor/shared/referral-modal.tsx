  ...
  const handleSubmit = async () => {
    ...
    try {
      await referralService.createReferral({
        ...
        reason:
          notes || `Referral to ${selectedDoctorObj?.name || "specialist"}`,
        ...
        {!isSuccess ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-base">
                ...
                to another doctor or department.
              </DialogDescription>
            </DialogHeader>
          ...
          <div className="py-12 flex flex-col items-center justify-center text-center animate-in zoom-in duration-300">
            ...
            <p className="text-muted-foreground max-w-xs mx-auto">
              ...
              <b>{selectedDoctorObj?.name || "the specialist"}</b>. They will
              receive access to the patient&apos;s records.
            </p>
          </div>
        )}
      </DialogContent>
