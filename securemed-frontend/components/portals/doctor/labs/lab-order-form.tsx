    ...
    const fetchTests = async () => {
      try {
        ...
        const uniqueCategories = Array.from(
          new Set(data.map((t: LabTest) => t.category)),
        ) as string[];
    ...
    return (
      <Card className="max-w-2xl mx-auto">
        <CardContent className="pt-12 pb-8 text-center">
          ...
          <Button onClick={resetForm}>Create Another Order</Button>
        </CardContent>
      </Card>
    );
  }
    ...
    <div className="max-w-4xl mx-auto p-4 space-y-6">
            ...
            {labTests.length === 0 ? (
              <div className="p-8 text-center text-muted-foreground">
                ...
                <p className="text-xs mt-1">
                  Please contact your administrator to configure lab tests.
                </p>
              </div>
                ...
                return (
                  ...
                  >
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        isSelected ? removeTest(test.id) : addTest(test)
                      }
                    >
                      {isSelected ? (
                        <X className="w-4 h-4" />
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-red-700">
              STAT orders require immediate processing. Please ensure this is
      ...
      <div className="flex justify-end gap-3">
        ...
        <Button
          ...
          disabled={
            !selectedPatient || selectedTests.length === 0 || isSubmitting
          }
