      ...
      <div className="bg-card rounded-2xl border border-border/60 shadow-sm p-6">
        ...
        <div className="space-y-3 text-xs text-muted-foreground">
          <Step n={1} color="bg-blue-500">
            Appointments create edges between <strong>Patients</strong>,{" "}
            <strong>Doctors</strong>, and <strong>Rooms</strong> in Neo4j.
          </Step>
          <Step n={2} color="bg-amber-500">
            When an infection is reported,{" "}
            <code className="bg-muted px-1 rounded">shortestPath</code> queries
            find transmission chains.
          </Step>
          <Step n={3} color="bg-red-500">
            Traces are scored by <strong>path length</strong> and{" "}
            <strong>time proximity</strong> between diagnoses.
          </Step>
        </div>
      </div>
      ...
      <div className="bg-card rounded-2xl border border-border/60 shadow-sm p-6">
        ...
        <div className="space-y-2 text-xs">
          ...
          <EdgeRow
            color="#10b981"
            name="WORKED_IN"
            desc="Doctor practised in Room"
          />
          <EdgeRow
            color="#8b5cf6"
            name="USED_EQUIPMENT"
            desc="Patient used Equipment"
          />
        </div>
      </div>
    </div>
