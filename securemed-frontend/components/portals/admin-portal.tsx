...
import InfectionTrackingPortal, {
  type InfectionTrackingCacheData,
} from "@/components/portals/admin/infection-tracking/infection-tracking-portal";
...
export default function AdminPortal({
  ...
  const [infectionTrackingCache, setInfectionTrackingCache] =
    useState<InfectionTrackingCacheData | null>(null);
