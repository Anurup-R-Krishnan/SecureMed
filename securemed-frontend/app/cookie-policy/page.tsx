            ...
            <div className="mx-auto max-w-3xl space-y-8">
                ...
                <div className="rounded-3xl border border-border/60 bg-card p-8 shadow-sm">
                    <div className="flex items-center gap-3 mb-6">
                        <div className="rounded-2xl bg-primary/10 p-3 text-primary"><Cookie className="h-6 w-6" /></div>
                        <h1 className="text-3xl font-black text-foreground">Cookie Policy</h1>
                    </div>
                    <div className="prose prose-sm text-muted-foreground leading-7 space-y-4">
                        <p>SecureMed uses cookies and similar technologies to provide, protect, and improve our services.</p>
                        ...
                        <h2 className="text-lg font-bold text-foreground">Functional Cookies</h2>
                        <p>Remember your preferences such as theme, language, and last-viewed portal tab.</p>
                        <h2 className="text-lg font-bold text-foreground">Analytics Cookies</h2>
                        <p>Help us understand how users interact with the platform so we can improve the experience. All analytics data is anonymized.</p>
