...
export default function SecuritySettingsPage() {
  ...
  const handleRegenerateCodes = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        toast.error(
          data.error || data.password?.[0] || "Failed to regenerate codes",
        );
        setIsLoading(false);
        return;
      }
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant={mfaState === "ACTIVE" ? "default" : "secondary"}
                className={
                  mfaState === "ACTIVE"
            ...
            {mfaState === "IDLE" && (
              <div className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  ...
                  requiring a verification code from your phone in addition to
                  your password.
                </p>
              ...
              <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
                <div className="flex items-start gap-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Each code can only be used once. You won&apos;t be able to
                      see them again after leaving this page. Use these codes to
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
                If you&apos;ve lost your recovery codes or used them all, you
                can generate a new set. This will invalidate all previous
                recovery codes.
              </p>
              <Button variant="outline" onClick={() => setIsRegenerating(true)}>
              ...
              <form onSubmit={handleRegenerateCodes} className="space-y-4">
                <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
                  <p className="text-sm text-amber-500">
                    ⚠️ This will invalidate all your existing recovery codes.
                    Make sure to save the new ones.
                  </p>
                </div>
