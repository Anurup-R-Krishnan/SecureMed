            ...
            <div className="mx-auto max-w-3xl space-y-8">
                ...
                <div className="rounded-3xl border border-border/60 bg-card p-8 shadow-sm">
                    ...
                    <div className="prose prose-sm text-muted-foreground leading-7 space-y-4">
                        <p>By using SecureMed Healthcare services, you agree to these terms. Please read them carefully.</p>
                        <h2 className="text-lg font-bold text-foreground">Eligibility</h2>
                        <p>You must be at least 18 years old (or accessing with parental consent) to create an account with SecureMed.</p>
                        <h2 className="text-lg font-bold text-foreground">Account Responsibility</h2>
                        ...
                        <p>SecureMed is a healthcare management platform. Clinical decisions are made by licensed healthcare providers. The platform does not replace professional medical advice.</p>
                        <h2 className="text-lg font-bold text-foreground">Limitation of Liability</h2>
                        <p>SecureMed is provided &quot;as is.&quot; We are not liable for service interruptions, data transmission delays, or third-party integrations beyond our control.</p>
