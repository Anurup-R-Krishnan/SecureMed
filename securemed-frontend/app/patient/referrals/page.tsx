...
export default function ReferralsPage() {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h3 className="text-2xl font-black text-foreground tracking-tight">Referrals</h3>
                <p className="text-muted-foreground">Manage ongoing referrals and specialist consultations</p>
            </div>
