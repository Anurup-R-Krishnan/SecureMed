...
import EnhancedAppointmentBooking from './patient/enhanced-appointment-booking';
...
interface EnhancedPatientPortalProps {
    onLogout: () => void;
...
export default function EnhancedPatientPortal({
    ...
    const tabs: { id: PatientTab; label: string; icon: React.ReactNode }[] = [
        ...
        { id: 'appointments', label: 'Book Appointment', icon: <Calendar className="h-5 w-5" /> },
        ...
        <div className="min-h-screen bg-background">
            ...
            >
                ...
                <div className="px-6 py-4 border-b border-sidebar-border">
                    ...
                    <p className="font-semibold text-sidebar-primary">{patientName}</p>
                    <p className="text-xs text-sidebar-foreground/60">Patient ID: {patientId}</p>
                </div>
            ...
            <main className="md:ml-64 min-h-screen">
                ...
                <div className="p-6">
                    <div className="max-w-7xl mx-auto">
                        ...
                        {activeTab === 'billing' && <PatientBilling patientId={patientId} />}
                    </div>
                </div>
            </main>
        </div>
